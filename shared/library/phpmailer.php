...
|   Authors: Andy Prevost (codeworxtech) codeworxtech@employee.sourceforge.net |
|          : Marcus Bointon (coolbru) coolbru@employee.sourceforge.net         |
 ...
 */
   ...
   * the older validation method for those employee. (http://php.net/manual/en/pcre.installation.php)
